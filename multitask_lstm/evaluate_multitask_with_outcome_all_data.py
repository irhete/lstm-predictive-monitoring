...
output_dir = "results"
params = "pd_fixed_trainratio80_outcome_all_data"
...
with open(results_file, 'w') as fout:
    ...
    for nr_events in range(2, max_len-1):
        ...
        X, y_a, y_t, y_o = dataset_manager.generate_3d_data_for_prefix_length_with_label_all_data(dt_test, max_len, nr_events)
        if X.shape[0] == 0:
            break
